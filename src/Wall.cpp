...
Wall::Wall() {
	vertex[0][0] = -5; vertex[0][1] = -0.5; vertex[0][2] = 0;
	vertex[1][0] = -5; vertex[1][1] = 0.5;  vertex[1][2] = 0;
	vertex[2][0] = 5;  vertex[2][1] = 0.5;  vertex[2][2] = 0;
	vertex[3][0] = 5;  vertex[3][1] = -0.5; vertex[3][2] = 0;
...
bool Wall::isFrontface(int faceindex, Camera camera) {
	GLfloat v[4];
