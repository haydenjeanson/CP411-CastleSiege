...
Battlement::Battlement() {
	vertex[0][0] = -0.5; vertex[0][1] = -0.5; vertex[0][2] = 3;
	vertex[1][0] = -0.5; vertex[1][1] = 0.5;  vertex[1][2] = 3;
	vertex[2][0] = 0.5;  vertex[2][1] = 0.5;  vertex[2][2] = 3;
	vertex[3][0] = 0.5;  vertex[3][1] = -0.5; vertex[3][2] = 3;
	vertex[4][0] = -0.5; vertex[4][1] = -0.5; vertex[4][2] = 3.5;
	vertex[5][0] = -0.5; vertex[5][1] = 0.5;  vertex[5][2] = 3.5;
	vertex[6][0] = 0.5;  vertex[6][1] = 0.5;  vertex[6][2] = 3.5;
	vertex[7][0] = 0.5;  vertex[7][1] = -0.5; vertex[7][2] = 3.5;
...
void Battlement::drawFace(int i) {
	glColor3f(1, 1, 1);
...
bool Battlement::isFrontface(int faceindex, Camera camera) {
	GLfloat v[4];
