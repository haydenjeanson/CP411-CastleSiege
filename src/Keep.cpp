...
Keep::Keep() {
	vertex[0][0] = -2; vertex[0][1] = -2; vertex[0][2] = 0;
	vertex[1][0] = -2; vertex[1][1] = 2;  vertex[1][2] = 0;
	vertex[2][0] = 2;  vertex[2][1] = 2;  vertex[2][2] = 0;
	vertex[3][0] = 2;  vertex[3][1] = -2; vertex[3][2] = 0;
	vertex[4][0] = -2; vertex[4][1] = -2; vertex[4][2] = 5;
	vertex[5][0] = -2; vertex[5][1] = 2;  vertex[5][2] = 5;
	vertex[6][0] = 2;  vertex[6][1] = 2;  vertex[6][2] = 5;
	vertex[7][0] = 2;  vertex[7][1] = -2; vertex[7][2] = 5;
...
bool Keep::isFrontface(int faceindex, Camera camera) {
	GLfloat v[4];
